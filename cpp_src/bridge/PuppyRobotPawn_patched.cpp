...
APuppyRobotPawn::APuppyRobotPawn()
{
    ...
    CollisionCapsule->SetCapsuleRadius(30.0f);
    ...
    // Helper: create a UStaticMeshComponent + MID with solid base color override.
    auto ApplyColorMID = [&](UStaticMeshComponent* M, const FLinearColor& Color)
    {
        ...
        if (MID)
        {
            // BasicShapeMaterial exposes both "BaseColor" and "Color" legacy names.
...
void APuppyRobotPawn::BeginPlay()
{
    ...
    UE_LOG(LogTemp, Warning, TEXT("[PuppyRobotPawn] >>>>> FIX-SNAP: about to snap to scene_home.initial_pose (-100,-300) <<<<<"));
    ...
    // MovementComponent which may not exist on a custom Pawn and silently no-ops.
    {
        ...
        UE_LOG(LogTemp, Warning, TEXT("[PuppyRobotPawn] FIX-SNAP-DONE: SetActorLocation=%s SetActorRotation=%s new=(%.1f,%.1f,%.1f) moved=%.2fcm [scene_home.robot.initial_pose (-1m,-3m)]"),
...
static const FHomeObstacle HOME_OBSTACLES[] = {
    // --- furniture (from scene_home.json obstacles, x100) ---
    { TEXT("living_room_sofa   "),  160.f,-330.f, 340.f,-270.f },
    { TEXT("living_room_table1 "), -375.f,-315.f,-225.f,-285.f },
    { TEXT("living_room_table2 "), -340.f,-255.f,-260.f,-245.f },
    { TEXT("bedroom1_bed       "), -500.f,  50.f,-400.f, 150.f },
    { TEXT("bedroom1_desk      "), -440.f,   0.f,-400.f,  40.f },
    { TEXT("bedroom1_shelf     "), -420.f, 165.f,-355.f, 195.f },
    { TEXT("study_desk         "), -480.f, 270.f,-360.f, 330.f },
    { TEXT("study_shelf        "), -435.f, 335.f,-405.f, 440.f },
    { TEXT("study_cabinet      "), -470.f, 230.f,-430.f, 270.f },
    { TEXT("bedroom2_bed       "), -300.f, 260.f,-200.f, 380.f },
    { TEXT("bedroom2_desk      "), -345.f, 260.f,-295.f, 310.f },
    { TEXT("bedroom2_shelf     "), -170.f, 335.f, -90.f, 365.f },
    { TEXT("bathroom_sink      "),  -80.f, 270.f, -20.f, 330.f },
    { TEXT("bathroom_toilet    "),   10.f, 270.f,  90.f, 330.f },
    { TEXT("bathroom_shelf     "),  -50.f, 345.f,  50.f, 395.f },
    { TEXT("storage_rack1      "),  130.f, 280.f, 270.f, 320.f },
    { TEXT("storage_rack2      "),  305.f, 235.f, 335.f, 265.f },
    { TEXT("dining_table       "),  135.f,  80.f, 215.f, 120.f },
    { TEXT("dining_chair1      "),  113.f,  33.f, 148.f,  68.f },
    { TEXT("dining_chair2      "),  203.f,  33.f, 238.f,  68.f },
    { TEXT("dining_chair3      "),  113.f, 133.f, 148.f, 168.f },
    { TEXT("dining_chair4      "),  203.f, 133.f, 238.f, 168.f },
    { TEXT("kitchen_counter1   "),  275.f, 150.f, 425.f, 210.f },
    { TEXT("kitchen_counter2   "),  420.f, 150.f, 480.f, 210.f },
    { TEXT("kitchen_fridge     "),  275.f, 155.f, 325.f, 205.f },
    // --- horizontal walls y=0 (scene_home y0_seg1..4) ---
    { TEXT("wall_y0_seg1       "), -500.f, -15.f,-350.f,  15.f },
    { TEXT("wall_y0_seg2       "), -200.f, -15.f,   0.f,  15.f },
    { TEXT("wall_y0_seg3       "),  100.f, -15.f, 200.f,  15.f },
    { TEXT("wall_y0_seg4       "),  350.f, -15.f, 500.f,  15.f },
    // --- horizontal walls y=2m (y2_seg1..5) ---
    { TEXT("wall_y2_seg1       "), -500.f, 185.f,-350.f, 215.f },
    { TEXT("wall_y2_seg2       "), -200.f, 185.f,   0.f, 215.f },
    { TEXT("wall_y2_seg3       "),  100.f, 185.f, 150.f, 215.f },
    { TEXT("wall_y2_seg4       "),  250.f, 185.f, 350.f, 215.f },
    { TEXT("wall_y2_seg5       "),  450.f, 185.f, 500.f, 215.f },
    // --- vertical wall segments + doors ---
    { TEXT("wall_v_LB1_door    "), -355.f,   0.f,-345.f,  40.f },
    { TEXT("wall_v_bed1_door   "), -355.f, 160.f,-345.f, 200.f },
    { TEXT("wall_v_B2Bath_door "), -105.f, 200.f, -95.f, 240.f },
    { TEXT("wall_v_bath_door   "), -105.f, 360.f, -95.f, 400.f },
    { TEXT("wall_v_DinStor     "),  245.f, 110.f, 255.f, 200.f },
    { TEXT("wall_v_BathStor_dr "),   95.f, 200.f, 105.f, 240.f },
    { TEXT("wall_v_stor_door   "),   95.f, 360.f, 105.f, 400.f },
    { TEXT("wall_v_kitchen     "),  345.f,   0.f, 355.f, 200.f },
};
